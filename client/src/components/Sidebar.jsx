    ...
    <Box component="nav">
      {isSidebarOpen && (
        ...
        >
              ...
              {navItems.map((item) => {
                ...
                return (
                  <ListItem key={item.text} disablePadding>
                    ...
                    >
                        <ListItemIcon sx={{ml:"2rem",color:active===lcText?theme.palette.primary[600]:theme.palette.secondary[200]}}>{item.icon}</ListItemIcon>
          ...
          <Box  m="0.5rem 0">
            <Divider/>
            <FlexBetween textTransform="none" gap="1 rem" m="1.5rem 2rem 0 3rem">
              <Box component="img"
              src={profileImage}
              alt="profile"
              width="40px"
...
{user.name}
  ...
  <Typography fontSize="0.8rem" fontWeight="bold" sx={{color:theme.palette.secondary[200]}}>
{user.occupation}
  </Typography>
  </Box>
